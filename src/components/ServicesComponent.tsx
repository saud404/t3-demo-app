  ...
  return (
    <div className=" p-8 antialiased">
      <div className="mt-12 rounded-lg bg-white p-4 py-8 shadow-xl">
        <h4 className="text-center text-4xl font-bold uppercase tracking-widest text-primary">
          Services
        </h4>
        <p className="mt-2 text-center text-sm text-gray-600">
          Here are some of the Parking Services
        </p>
        <div className="mt-4 grid grid-cols-1 gap-4 px-2 md:grid-cols-2 xl:gap-12 xl:px-12">
          <div className="mt-8 flex space-x-8">
            ...
            <div>
              ...
              <a
                href="#"
                className="capitalize text-primary hover:text-primary hover:underline"
                title="Read More"
              >
                Read More
              </a>
